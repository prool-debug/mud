...
Чуть позже. Не запустилось. Измнение файла Cmakelist и файла исходника main.cpp тоже не вызвало CI.

20.04.2026. Синхронизировал с апстримом. CI не запустилось. А в другом форке запускается...
